...
import { ApproveEmail } from "@/components/emails/ApproveEmail";
...
export async function POST(request: Request) {
  try {
    ...
    if (emailError) {
      console.error("Resend approve email error:", emailError);
      return NextResponse.json(
    ...
    console.error("Error in /api/email/approve:", err);
    return NextResponse.json(
